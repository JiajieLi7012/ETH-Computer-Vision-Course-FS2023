...
def main():
  ...
  # TODO
  e_im1.SetPose(identity_matrix, zero_vector)
  for rotation, translation in possible_relative_poses:
    e_im2.SetPose(rotation, translation)
    triangulated_pts, _, _ = TriangulatePoints(K, e_im1, e_im2, e_matches)
    num_valid_pts = len(triangulated_pts)
    if num_valid_pts > max_points:
        max_points = num_valid_pts
